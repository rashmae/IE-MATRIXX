  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex transition-colors duration-300">
      ...
      <main className="flex-1 p-6 lg:p-10 pb-32 lg:pb-10 overflow-x-hidden">
        <div className="mb-12">
          <h1 className="text-4xl frosted-header font-bold tracking-tight">Student Profile</h1>
          <p className="text-foreground/60 mt-1 text-sm font-medium">Manage your account and application settings.</p>
        </div>
